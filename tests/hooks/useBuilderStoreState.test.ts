...
const mockedStore = vi.hoisted(() => {
  const state = {
    ...
    setRecommendationPlaystyle: vi.fn(),
    toggleFavoriteType: vi.fn(),
    toggleAvoidedType: vi.fn(),
    togglePreferredRole: vi.fn(),
...
describe("useBuilderStoreState", () => {
  it("selects and exposes store slices plus action references", () => {
    ...
    expect(result).toMatchObject({
      ...
      setRecommendationPlaystyle: mockedStore.state.setRecommendationPlaystyle,
      toggleFavoriteType: mockedStore.state.toggleFavoriteType,
      toggleAvoidedType: mockedStore.state.toggleAvoidedType,
      togglePreferredRole: mockedStore.state.togglePreferredRole,
