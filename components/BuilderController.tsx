  ...
  const session = useMemo(
    () => ({
      ...
      actions: {
        ...
        setRecommendationPlaystyle: store.setRecommendationPlaystyle,
        toggleFavoriteType: store.toggleFavoriteType,
        toggleAvoidedType: store.toggleAvoidedType,
        togglePreferredRole: store.togglePreferredRole,
    ...
    [
      ...
      store.setRecommendationPlaystyle,
      store.toggleFavoriteType,
      store.toggleAvoidedType,
      store.togglePreferredRole,
  ...
  const team = useMemo(
    () => ({
      ...
      actions: {
        ...
        releaseMember: actions.releaseMember,
