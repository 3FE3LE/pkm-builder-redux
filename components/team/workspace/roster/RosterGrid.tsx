...
function AddMemberSlot({
  ...
  return (
    ...
    >
      <div className="app-soft-panel flex h-20 w-20 items-center justify-center rounded-xl transition group-hover:scale-[1.03] group-hover:border-primary-line-emphasis">
