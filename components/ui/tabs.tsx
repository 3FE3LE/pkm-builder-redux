...
function TabsTrigger({ className, ...props }: TabsPrimitive.Tab.Props) {
  return (
    <TabsPrimitive.Tab
      ...
      className={cn(
        "app-segmented-item pixel-face relative inline-flex h-9 items-center justify-center gap-1.5 px-3 py-1.5 text-sm whitespace-nowrap text-foreground/60 group-data-vertical/tabs:w-full group-data-vertical/tabs:justify-start hover:text-foreground focus-visible:border-ring focus-visible:ring-[3px] focus-visible:ring-ring/50 focus-visible:outline-1 focus-visible:outline-ring disabled:pointer-events-none disabled:opacity-50 aria-disabled:pointer-events-none aria-disabled:opacity-50 dark:text-muted-foreground dark:hover:text-foreground group-data-[variant=default]/tabs-list:data-active:shadow-sm group-data-[variant=line]/tabs-list:data-active:shadow-none [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",
        "group-data-[variant=line]/tabs-list:bg-transparent group-data-[variant=line]/tabs-list:data-active:bg-transparent dark:group-data-[variant=line]/tabs-list:data-active:border-transparent dark:group-data-[variant=line]/tabs-list:data-active:bg-transparent",
        "group-data-[variant=default]/tabs-list:text-text-soft group-data-[variant=default]/tabs-list:hover:bg-surface-4 group-data-[variant=default]/tabs-list:data-active:border-warning-line group-data-[variant=default]/tabs-list:data-active:bg-warning-fill group-data-[variant=default]/tabs-list:data-active:text-[hsl(39_100%_82%)] group-data-[variant=default]/tabs-list:data-active:shadow-[inset_0_1px_0_rgba(255,255,255,0.08)] dark:data-active:border-input dark:data-active:bg-input/30 dark:data-active:text-foreground",
